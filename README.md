...
platform integration; see `doc/architecture/0011-browser-authentication-boundary.md`
...
[Play Store Release Process](file:///Users/pk/src/refineid-android/doc/distribution/release-process.artifact.md).
For the calendar versioning design, see `doc/architecture/0006-calendar-versioning.md`.
